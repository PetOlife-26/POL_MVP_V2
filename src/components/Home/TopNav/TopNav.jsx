...
/**
 * USAGE:
 * Replace logoSrc prop with your actual PetOlife logo image path.
 * Example: <TopNav logoSrc={require("../../assets/petolife-logo.png")} />
 * The logo image should be just the "PetOlife" wordmark with the paw icon.
 */
    ...
    <nav className="topnav">
      <div className="topnav__left">
        <div className="topnav__brand">
          <img src={petolifeLogo} alt="" className="topnav__logo-img" />
