...
/**
 * Shared BottomNav — used by HomeScreen, ChecklistPage, and other in-app pages.
 * Props:
 *   active     — which tab key is currently active ("home", "checklist", etc.)
 *   onNavigate — callback(tabKey) when a tab is tapped
 *   onFabPress — callback when the centre FAB ("+") button is tapped
 */
